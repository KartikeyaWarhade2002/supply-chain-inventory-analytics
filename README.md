...
These visualizations provide quick insights into revenue performance, market performance, customer segments, shipping efficiency and operational KPIs before building the final Power BI dashboard.

---

## Revenue by Market

Compares total revenue generated across different global markets to identify the strongest-performing regions.

This visualization helps decision-makers evaluate regional business performance and identify opportunities for market expansion.

![Revenue by Market](charts/01_revenue_by_market.png)

---

## Monthly Revenue Trend

Shows how revenue changes throughout the year, highlighting seasonal demand patterns and overall business performance.

This visualization helps stakeholders monitor monthly sales performance, identify peak business periods and support forecasting decisions.

![Monthly Revenue Trend](charts/02_monthly_revenue_trend.png)

---

## Revenue by Shipping Mode

Compares total revenue generated across different shipping methods.

This analysis helps evaluate customer shipping preferences and supports logistics planning and shipping service optimization.

![Revenue by Shipping Mode](charts/03_revenue_by_shipping_mode.png)

---

## Late Delivery Rate by Shipping Mode

Analyzes the percentage of late deliveries for each shipping method.

This visualization helps identify operational bottlenecks, improve delivery performance and enhance customer satisfaction.

![Late Delivery Rate](charts/04_late_delivery_rate.png)

---

## Top Product Categories by Revenue

Identifies the highest revenue-generating product categories across the business.

This visualization supports inventory planning, category management and merchandising decisions by highlighting the strongest-performing product categories.

![Top Categories](charts/05_top_categories_by_revenue.png)

---

## Revenue by Customer Segment

Compares revenue generated by Consumer, Corporate and Home Office customer segments.

This analysis helps businesses understand customer purchasing behaviour and identify the most valuable customer groups.

![Customer Segment Revenue](charts/06_revenue_by_customer_segment.png)
